...
for ($choice_count = 0; $choice_count < $total_choice_count; $choice_count++) {
    ...
    <div class="<?= 'wqpo-choice' . $choice_order ?><?= $modifies_price . $tags ?>" data-price="<?= $choice_prices[$choice_count] ?>"<?php echo $showtags . $hidetags . $enable_modifiers . $choice_modifiers_string; ?> data-type="<?= $option_types[$option_count] ?>">
